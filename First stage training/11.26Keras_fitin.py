...
history = model.fit(X_train, y_train, validation_split=0.25, epochs=100000, batch_size=32, verbose=1)
...
#layer_output2 = get_3rd_layer_output([spec_train])[1]
#layer_output3 = get_3rd_layer_output([spec_train])[2]
#layer_output4 = get_3rd_layer_output([spec_train])[3]
