...
def generate_spectrogram_data(start_from=10001, number=100, noise_power=0, length=2):
    spec = np.zeros(512*3)
    j = 0
    while j < number:
...
def generate_mask_data(start_from=10001, number=100, noise_power=0, length=1):
    mask = np.zeros(512*3)
    j = 0
    while j < number:
        x1 = read_Flac(start_from + j)[0]
...
clear_spec_train_1000 = generate_spectrogram_data(start_from=10001, number=1000, noise_power=0, length=3)
clear_mask_train_1000 = generate_mask_data(start_from=10001, number=1000, noise_power=0, length=3)
...
clear_spec_train_1000 = generate_spectrogram_data(start_from=10001, number=1000, noise_power=0, length=2)
clear_spec_test_1000 = generate_spectrogram_data(start_from=11001, number=1000, noise_power=0, length=2)

clear_mask_train_1000 = generate_mask_data(start_from=10001, number=1000, noise_power=0, length=2)
clear_mask_test_1000 = generate_mask_data(start_from=11001, number=1000, noise_power=0, length=2)

np.savetxt('1209.2_spec_train_1000.txt', clear_spec_train_1000, delimiter = ' ')
np.savetxt('1209.2_spec_test_1000.txt', clear_spec_test_1000, delimiter = ' ')
np.savetxt('1209.2_mask_train_1000.txt', clear_mask_train_1000, delimiter = ' ')
np.savetxt('1209.2_mask_test_1000.txt', clear_mask_test_1000, delimiter = ' ')
