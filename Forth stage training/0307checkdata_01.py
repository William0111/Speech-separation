...
clear_spec_train_1000 = generate_spectrogram_data(start_from=10001, number=28000, noise_power=0, length=3)
clear_mask_train_1000 = generate_mask_data(start_from=10001, number=28000, noise_power=0, length=3)

np.savetxt('0307_spec_train_280000data_3columns.txt', clear_spec_train_1000, delimiter = ' ')
np.savetxt('0307_mask_train_280000data_3columns.txt', clear_mask_train_1000, delimiter = ' ')
