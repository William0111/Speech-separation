...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 20 23:17:21 2019
...
'''
This to generate data to use LSTM 10 columns to predict only 1 columns
...
clear_mask_train_1000 = generate_mask_data(start_from=10001, number=1000, noise_power=0, length=1)
clear_mask_test_1000 = generate_mask_data(start_from=11001, number=1000, noise_power=0, length=1)

np.savetxt('0220_spec_train_1000*5120.txt', clear_spec_train_1000, delimiter = ' ')
np.savetxt('0220_spec_test_1000*5120.txt', clear_spec_test_1000, delimiter = ' ')
np.savetxt('0220_mask_train_1000*512.txt', clear_mask_train_1000, delimiter = ' ')
np.savetxt('0220_mask_test_1000*512.txt', clear_mask_test_1000, delimiter = ' ')
