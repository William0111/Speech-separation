...
def generate_spectrogram_data(start_from=10001, number=100, noise_power=0, length=3):
    spec = np.zeros(512*3)
    j = 0
    while j < number:
...
def generate_mask_data(start_from=10001, number=100, noise_power=0, length=3):
    mask = np.zeros(512*3)
    j = 0
    while j < number:
        x1 = read_Flac(start_from + j)[0]
...
clear_spec_test_1000 = generate_spectrogram_data(start_from=11001, number=1000, noise_power=0, length=3)

clear_mask_train_1000 = generate_mask_data(start_from=10001, number=1000, noise_power=0, length=3)
clear_mask_test_1000 = generate_mask_data(start_from=11001, number=1000, noise_power=0, length=3)

np.savetxt('0126_spec_train_1000.txt', clear_spec_train_1000, delimiter = ' ')
np.savetxt('0126_spec_test_1000.txt', clear_spec_test_1000, delimiter = ' ')
np.savetxt('0126_mask_train_1000.txt', clear_mask_train_1000, delimiter = ' ')
np.savetxt('0126_mask_test_1000.txt', clear_mask_test_1000, delimiter = ' ')
