...
np.savetxt('0131_spec_train_1000*5120.txt', clear_spec_train_1000, delimiter = ' ')
np.savetxt('0131_spec_test_1000*5120.txt', clear_spec_test_1000, delimiter = ' ')
np.savetxt('0131_mask_train_1000*5120.txt', clear_mask_train_1000, delimiter = ' ')
np.savetxt('0131_mask_test_1000*5120.txt', clear_mask_test_1000, delimiter = ' ')
