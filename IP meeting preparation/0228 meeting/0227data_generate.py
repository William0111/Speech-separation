...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 28 07:07:30 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 26 21:20:31 2019
...
def generate_spectrogram_data(start_from=10001, number=100, noise_power=0.5, length=10):
    spec = np.zeros(512*10)
    j = 0
    while j < number:
...
clear_spec_train_1000 = generate_spectrogram_data(start_from=10001, number=2000, noise_power=0, length=10)
#clear_spec_test_1000 = generate_spectrogram_data(start_from=11001, number=2000, noise_power=0, length=10)

clear_mask_train_1000 = generate_mask_data(start_from=10001, number=2000, noise_power=0, length=10)
#clear_mask_test_1000 = generate_mask_data(start_from=11001, number=2000, noise_power=0, length=10)

np.savetxt('0228_spec_train_2000*5120.txt', clear_spec_train_1000, delimiter = ' ')
#np.savetxt('0228_spec_test_2000*5120.txt', clear_spec_test_1000, delimiter = ' ')
np.savetxt('0228_mask_train_2000*5120.txt', clear_mask_train_1000, delimiter = ' ')
#np.savetxt('0228_mask_test_2000*5120.txt', clear_mask_test_1000, delimiter = ' ')
