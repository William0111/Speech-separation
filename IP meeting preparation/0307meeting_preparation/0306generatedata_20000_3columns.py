...
def generate_spectrogram_data(start_from=100001, number=20000, noise_power=0, length=3):
...
def generate_mask_data(start_from=100001, number=20000, noise_power=0, length=3):
...
#clear_spec_train_1000 = generate_spectrogram_data(start_from=100001, number=20000, noise_power=0, length=3)
#clear_mask_train_1000 = generate_mask_data(start_from=100001, number=20000, noise_power=0, length=3)

#np.savetxt('0306_spec_train_20000data_3columns.txt', clear_spec_train_1000, delimiter = ' ')
#np.savetxt('0306_mask_train_20000data_3columns.txt', clear_mask_train_1000, delimiter = ' ')

#try to plot to check
x1 = read_Flac(100000 + 1)[0]
x1 = x1[:16000 * 2]
...
y_mask = x1_spec.reshape(200,512)
