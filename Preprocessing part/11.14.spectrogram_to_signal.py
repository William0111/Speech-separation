...
data, rate = \
    sf.read('/Users/admin/Desktop/practiceunderpycharm/flac_dataforcnn/10003.flac')
data = data[:16000 * 3]
...
cax = ax.matshow(np.transpose(inverted_spectrogram), interpolation='nearest', aspect='auto', cmap=plt.cm.afmhot,
                 origin='lower')
fig.colorbar(cax)
